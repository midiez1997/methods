...
public class Task03 extends StandardInputTask {
    ...
    static String getColorHealthPoint(int currentHealthPoint, int maxHealthPoint) {
        ...
        double currentHealthPointProcent = currentHealthPoint * 100.0 / maxHealthPoint;
        if (currentHealthPointProcent < 0 || currentHealthPointProcent > 100) {
        } else  if (currentHealthPointProcent == 0) {
            return null;
        } else  if (currentHealthPointProcent < 25) {
            return "RED";
        } else  if (currentHealthPointProcent < 50) {
            return "ORANGE";
        } else  if (currentHealthPointProcent < 75) {
            return "YELLOW";
        } else  if (currentHealthPointProcent <= 100) {
            return "GREEN";
        }
        return null;
    }
